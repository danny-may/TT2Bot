...
using TT2Bot.GameEntity.Services;
using TT2Bot.Models;
...
namespace TT2Bot.Services
{
    class TT2DataService
    {
        ...
        public GameEntityService<Artifact> Artifacts { get; }
        public GameEntityService<Equipment> Equipment { get; }
        public GameEntityService<Pet> Pets { get; }
        public GameEntityService<HelperSkill> HelperSkills { get; }
        public GameEntityService<Helper> Helpers { get; }
        public GameEntityService<Skill> SkillTree { get; }
