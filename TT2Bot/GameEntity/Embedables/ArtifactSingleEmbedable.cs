...
{
    class ArtifactSingleEmbedable : GameEntitySingleEmbedable<Artifact>
    {
        protected override ILocalisable<string> Footer => new LocalisedString(ArtifactText.SHOW_FOOTER, BotUser.Username, Entity.FileVersion);
        protected override ILocalisable<string> Title => new LocalisedString(ArtifactText.SHOW_TITLE, Entity.Name);

        public ArtifactSingleEmbedable(ICommandContext context, Artifact entity, int? from, int? to) : base(context, entity, from, to) { }
