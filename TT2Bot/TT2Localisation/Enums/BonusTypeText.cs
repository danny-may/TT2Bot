            ...
            public static class BonusTypeText
            {
                ...
                public static IReadOnlyDictionary<string, string> Defaults { get; }
                    = new Dictionary<BonusType, string>
                    {
                        ...
                        { BonusType.CritBoostSkillAmount, "Deadly Strike Effect" },
                        ...
                        { BonusType.HandOfMidasSkillAmount, "Hand Of Midas Gold Bonus" },
                        ...
                        { BonusType.HelperBoostSkillAmount, "War Cry Damage Bonus" },
